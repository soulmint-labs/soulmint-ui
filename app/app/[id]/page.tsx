...
const product = {
    name: 'Red hat redemption',
    version: { name: '1.0', date: 'June 5, 2021', datetime: '2021-06-05' },
    price: '220 SOUL',
    description:
        'Red Hat Redemption is a game that you can play with your friends. You can play it with 2-4 players. The game is the most popular game in the world.',
    highlights: [
        'Play with your friends',
        'Online multiplayer',
        'Play with 2-4 players',
    ],
    imageSrc: 'https://images.unsplash.com/photo-1507228060299-33b5fcb63bc6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2052&q=80',
                            ...
                            <Tab.Panels as={Fragment}>
                                <Tab.Panel className="-mb-10">
                                    ...
                                    {reviews.featured.map((review, reviewIdx) => (
                                        <div key={review.id} className="flex space-x-4 text-sm text-gray-400">
                                            ...
                                            <div className={classNames(reviewIdx === 0 ? '' : 'border-t border-gray-700', 'flex-1 py-10')}>
                                                <h3 className="font-medium text-gray-100">{review.author}</h3>
                                                <p>
                                                ...
                                                <div
                                                    className="prose prose-sm mt-4 max-w-none text-gray-400"
                                ...
                                <Tab.Panel className="text-sm text-gray-400">
                                    <h3 className="sr-only">Frequently Asked Questions</h3>

                                    <dl>
                                        {faqs.map((faq) => (
                                            <Fragment key={faq.question}>
                                                <dt className="mt-10 font-medium text-gray-100">{faq.question}</dt>
                                                <dd className="prose prose-sm mt-2 max-w-none text-gray-400">
                                                    <p>{faq.answer}</p>
                                                </dd>
                                            </Fragment>
                                        ))}
